...
module.exports = {
    ...
    //Qi View object
    QiView: function(qiView) {
        this.Id = qiView.Id;
        this.Name = qiView.Name;
        this.SourceTypeId = qiView.SourceTypeId;
        this.TargetTypeId = qiView.TargetTypeId;
        if (qiView.Properties) {
            this.Properties = qiView.Properties;
        }
    },

    // Qi View Property
    QiViewProperty: function (qiViewProperty) {
        if (qiViewProperty.SourceId) {
            this.SourceId = qiViewProperty.SourceId;
        }
        if (qiViewProperty.TargetId) {
            this.TargetId = qiViewProperty.TargetId;
        }
    }
}