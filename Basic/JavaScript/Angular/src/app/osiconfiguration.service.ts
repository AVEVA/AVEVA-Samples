...
export class ConfigurationService {
  ...
  public get adalConfig(): AdalConfig {
    ...
    return {
         ...
         endpoints: [ { endpointURL: config.SystemEndpoint, endpointResourceURI : config.SystemResourceURI },
                      { endpointURL: config.QiEndPoint, endpointResourceURI : config.QiResourceURI },
                    ],
