...
public class QiClient {
    ...
    private String getTypePath = typesBase + "/{typeId}";
    ...
    static protected AuthenticationResult AcquireAuthToken() {
        // get configuration
        String _clientId = getConfiguration("_clientId");
        String _clientSecret = getConfiguration("_clientSecret");
        String _authority = getConfiguration("_authority");
        String _resource = getConfiguration("_resource");
        ...
        try {
            ...
            ClientCredential userCred = new ClientCredential(_clientId, _clientSecret);
