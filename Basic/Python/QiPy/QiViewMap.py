...
import json
import inspect
from QiViewProperty import QiViewProperty

class QiViewMap(object):
    """QiViewMap definitions"""
    ...
    def fromJson(jsonObj):
        return QiViewMap.fromDictionary(jsonObj)
        ...
        if 'Properties' in content:
            ...
            if properties is not None and len(properties) > 0:
                ...
                for value in properties:
                    viewMap.Properties.append(QiViewProperty.fromDictionary(value))
