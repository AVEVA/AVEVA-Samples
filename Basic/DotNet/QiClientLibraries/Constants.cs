namespace QiClientLibsSample
{
    public class Constants
    {
        ...
        public const string TenantId = "PLACEHOLDER_REPLACE_WITH_RESOURCE";  // A guid for the Id of the tenant --- NOT the SecurityAppId
        public const string SecurityResource = "PLACEHOLDER_REPLACE_WITH_RESOURCE";
        public const string SecurityAuthority = "PLACEHOLDER_REPLACE_WITH_AUTHORITY"; /*Ex: "https://login.windows.net/<TENANT-NAME>.onmicrosoft.com"*/
