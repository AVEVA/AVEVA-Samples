...
{
    public sealed class QiSecurityHandler : DelegatingHandler
    {
        private readonly string _resource;
        private readonly ClientCredential _clientCredential;
        private readonly string _authority;

        public QiSecurityHandler(string resource, string tenantId, string aadInstanceFormat, string appId, string appKey)
        {
            _resource = resource;
