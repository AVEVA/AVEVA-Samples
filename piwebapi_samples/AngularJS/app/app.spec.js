...
describe('AppComponent', function() {
   ...
   */
  beforeEach(function() {
    const i = angular.injector(['ng']); const rs = i.get('$rootScope');
    http = i.get('$http');
  ...
  it('createDatabase should return a status code of 201 when creating a new database', (done) => {
    let returnCode = 0;
    returnCode = scope.createDatabase(piWebAPIUrl, assetServer, userName, userPassword, authType);
  ...
  it('createCategory should return a status code of 201 when creating a new category', (done) => {
    let returnCode = 0;
    returnCode = scope.createCategory(piWebAPIUrl, assetServer, userName, userPassword, authType);
    returnCode.then(function(result) {
      expect(result).toEqual(201);
      done();
    });
  ...
  it('createTemplate should return a status code of 201 when creating a new template', (done) => {
    let returnCode = 0;
    returnCode = scope.createTemplate(piWebAPIUrl, assetServer, piServer, userName, userPassword, authType);
    returnCode.then(function(result) {
      expect(result).toEqual(201);
      done();
    });
  ...
  it('createElement should return a status code of 200 when creating a new element', (done) => {
    let returnCode = 0;
    returnCode = scope.createElement(piWebAPIUrl, assetServer, userName, userPassword, authType);
    returnCode.then(function(result) {
  ...
  it('writeSingleValue should return a status code of 202 when writing a single value', function(done) {
    let returnCode = 0;
    returnCode = scope.writeSingleValue(piWebAPIUrl, assetServer, userName, userPassword, authType);
    returnCode.then(function(result) {
  ...
  it('writeSetOfValues should return a status code of 202 when writing a set of values', function(done) {
    let returnCode = 0;
    returnCode = scope.writeSetOfValues(piWebAPIUrl, assetServer, userName, userPassword, authType);
    returnCode.then(function(result) {
      expect(result).toEqual(202);
      done();
    });
  ...
  it('updateAttributeValue should return a status code of 204 when updating an attribute value', function(done) {
    let returnCode = 0;
    returnCode = scope.updateAttributeValue(piWebAPIUrl, assetServer, userName, userPassword, authType);
    returnCode.then(function(result) {
  ...
  it('readSingleValue should return a status code of 200 when reading a single value', function(done) {
    let returnCode = 0;
    returnCode = scope.readSingleValue(piWebAPIUrl, assetServer, userName, userPassword, authType);
    returnCode.then(function(result) {
      expect(result).toEqual(200);
      done();
    });
  ...
  it('readSetOfValues should return a status code of 200 when reading a set of values', function(done) {
    let returnCode = 0;
    returnCode = scope.readSetOfValues(piWebAPIUrl, assetServer, userName, userPassword, authType);
    returnCode.then(function(result) {
      expect(result).toEqual(200);
      done();
    });
  ...
  it('reducePayloadWithSelectedFields should return a status code of 200 when reducing payload with selected fields', function(done) {
    let returnCode = 0;
    returnCode = scope.reducePayloadWithSelectedFields(piWebAPIUrl, assetServer, userName, userPassword, authType);
    returnCode.then(function(result) {
      expect(result).toEqual(200);
      done();
    });
  ...
  it('doBatchCall should return a status code of 207 when performing a batch call', function(done) {
    let returnCode = 0;
    returnCode = scope.doBatchCall(piWebAPIUrl, assetServer, userName, userPassword, authType);
    returnCode.then(function(result) {
  ...
  it('deleteElement should return a status code of 204 when deleteing the element', function(done) {
    let returnCode = 0;
    returnCode = scope.deleteElement(piWebAPIUrl, assetServer, userName, userPassword, authType);
    returnCode.then(function(result) {
      expect(result).toEqual(204);
      done();
    });
  ...
  it('deleteTemplate should return a status code of 204 when deleteing the template', function(done) {
    let returnCode = 0;
    returnCode = scope.deleteTemplate(piWebAPIUrl, assetServer, userName, userPassword, authType);
    returnCode.then(function(result) {
      expect(result).toEqual(204);
      done();
    });
  ...
  it('deleteCategory should return a status code of 204 when deleteing the category', function(done) {
    let returnCode = 0;
    returnCode = scope.deleteCategory(piWebAPIUrl, assetServer, userName, userPassword, authType);
    returnCode.then(function(result) {
      expect(result).toEqual(204);
      done();
    });
  ...
  it('deleteDatabase should return a status code of 204 when deleteing the database', function(done) {
    let returnCode = 0;
    returnCode = scope.deleteDatabase(piWebAPIUrl, assetServer, userName, userPassword, authType);
    returnCode.then(function(result) {
      expect(result).toEqual(204);
      done();
    });
