...
public class Program {
    ...
    public static boolean toRun(Boolean test) throws Exception {
        ...
        try {
            ...
            while (count == 0 || (!test && count < 2)) {
                ...
                if (sendToOCS) {
                    sendOMF(create_data_values_for_NonTimeStampIndexAndMultiIndex_type("Container5", "Container6"),
                            "data", "create");
                }
    ...
    private static String create_data_values_for_NonTimeStampIndexAndMultiIndex_type(String NonTimeStampIndexID,
            String MultiIndexId) {
        ...
        return "[" + "        {" + "            \"containerid\": \"" + NonTimeStampIndexID + "\","
                + "            \"values\": [" + "                {" + "                    \"Value\": "
                + ThreadLocalRandom.current().nextInt(0, 88) + "," + "                    \"Int_Key\": "
                + integer_index1 + "" + "                }," + "                {" + "                    \"Value\": "
                + ThreadLocalRandom.current().nextInt(0, 88) + "," + "                    \"Int_Key\": "
                + integer_index1 + 1 + "" + "                }" + "            ]" + "        }," + "        {"
                + "            \"containerid\": \"" + MultiIndexId + "\"," + "            \"values\": ["
                + "                {" + "                    \"Value1\": "
                + ThreadLocalRandom.current().nextInt(-125, 0) + "," + "                    \"Value2\": "
                + ThreadLocalRandom.current().nextInt(0, 42) + "," + "                    \"IntKey\": "
    ...
    private static String getLink2() {
        return "[" + "        {" + "            \"typeid\": \"__Link\"," + "            \"values\": ["
                + "                {" + "                    \"source\": {"
                + "                            \"typeid\": \"FirstStaticType\","
                + "                            \"index\": \"Asset1\"" + "                    },"
                + "                    \"target\": {" + "                            \"containerid\": \"Container1\""
                + "                    }" + "                }," + "                {"
                + "                    \"source\": {" + "                            \"typeid\": \"SecondStaticType\","
                + "                            \"index\": \"Asset2\"" + "                    },"
                + "                    \"target\": {" + "                            \"containerid\": \"Container2\""
                + "                    }" + "                }," + "                {"
                + "                    \"source\": {" + "                            \"typeid\": \"SecondStaticType\","
                + "                            \"index\": \"Asset2\"" + "                    },"
                + "                    \"target\": {" + "                            \"containerid\": \"Container3\""
                + "                    }" + "                }," + "                {"
                + "                    \"source\": {" + "                            \"typeid\": \"SecondStaticType\","
                + "                            \"index\": \"Asset2\"" + "                    },"
                + "                    \"target\": {" + "                            \"containerid\": \"Container4\""
                + "                    }" + "                }" + "            ]" + "        }" + "    ]";
    }
    ...
    private static String getLink1() {
        return "[" + "        {" + "            \"typeid\": \"__Link\"," + "            \"values\": ["
                ...
                + "                            \"typeid\": \"FirstStaticType\","
                + "                            \"index\": \"_ROOT\"" + "                    },"
                + "                    \"target\": {" + "                            \"typeid\": \"FirstStaticType\","
                + "                            \"index\": \"Asset1\"" + "                    }" + "                },"
                + "                {" + "                    \"source\": {"
                + "                            \"typeid\": \"FirstStaticType\","
                + "                            \"index\": \"Asset1\"" + "                    },"
                + "                    \"target\": {" + "                            \"typeid\": \"SecondStaticType\","
                + "                            \"index\": \"Asset2\"" + "                    }" + "                }"
                + "            ]" + "        }" + "    ]";
    }

    private static String getStatic1() {
        return "[" + "        {" + "            \"typeid\": \"FirstStaticType\"," + "            \"values\": ["
                + "                {" + "                    \"index\": \"Asset1\","
                + "                    \"name\": \"Parent element\","
    ...
    private static String getMultiIndexContainers() {
        return "[" + "            {" + "                \"id\": \"Container5\","
                + "                \"typeid\": \"NonTimeStampIndex\"" + "            }," + "            {"
                + "                \"id\": \"Container6\"," + "                \"typeid\": \"MultiIndex\""
                + "            }" + "        ]";
    }
    ...
    private static String getDynamicTypeMultiIndexString() {
        return "[" + "            {" + "                \"id\": \"NonTimeStampIndex\","
                + "                \"name\": \"NonTimeStampIndex\","
                + "                \"classification\": \"dynamic\"," + "                \"type\": \"object\","
                + "                \"description\": \"Integer Fun\"," + "                \"properties\": {"
                + "                    \"Value\": {" + "                        \"type\": \"number\","
                + "                        \"name\": \"Value\","
                + "                        \"description\": \"This could be any value\"" + "                    },"
                + "                    \"Int_Key\": {" + "                        \"type\": \"integer\","
                + "                        \"name\": \"Integer Key\"," + "                        \"isindex\": true,"
                + "                        \"description\": \"A non-time stamp key\"" + "                    }"
                + "                }" + "            },        " + "            {"
                + "                \"id\": \"MultiIndex\"," + "                \"name\": \"Multi_index\","
                + "                \"classification\": \"dynamic\"," + "                \"type\": \"object\","
                ...
                + "                        \"description\": \"This could be any value\""
                + "                    },                " + "                    \"Value2\": {"
                + "                        \"type\": \"number\"," + "                        \"name\": \"Value2\","
                + "                        \"description\": \"This could be any value too\"" + "                    },"
                + "                    \"IntKey\": {" + "                        \"type\": \"integer key part 1\","
    ...
    private static String getDynamicTypeString() {
        return "[" + "        {" + "            \"id\": \"FirstDynamicType\","
                + "            \"name\": \"First dynamic type\"," + "            \"classification\": \"dynamic\","
                + "            \"type\": \"object\"," + "            \"description\": \"not in use\","
                + "            \"properties\": {" + "                \"timestamp\": {"
                + "                    \"format\": \"date-time\"," + "                    \"type\": \"string\","
                + "                    \"isindex\": true," + "                    \"description\": \"not in use\""
                + "                }," + "                \"IntegerProperty\": {"
                + "                    \"type\": \"integer\","
                + "                    \"description\": \"PI point data referenced integer attribute\""
                + "                }" + "            }" + "        }," + "        {"
                + "            \"id\": \"SecondDynamicType\"," + "            \"name\": \"Second dynamic type\","
                + "            \"classification\": \"dynamic\"," + "            \"type\": \"object\","
                + "            \"description\": \"not in use\"," + "            \"properties\": {"
                + "                \"timestamp\": {" + "                    \"format\": \"date-time\","
                + "                    \"type\": \"string\"," + "                    \"isindex\": true,"
                + "                    \"description\": \"not in use\"" + "                },"
                + "                \"NumberProperty1\": {" + "                    \"type\": \"number\","
                + "                    \"description\": \"PI point data referenced number attribute 1\","
                + "                    \"format\": \"float64\"" + "                },"
                + "                \"NumberProperty2\": {" + "                    \"type\": \"number\","
                + "                    \"description\": \"PI point data referenced number attribute 2\","
                + "                    \"format\": \"float64\"" + "                },"
                + "                \"StringEnum\": {" + "                    \"type\": \"string\","
                + "                    \"enum\": [\"False\", \"True\"],"
                + "                    \"description\": \"String enumeration to replace boolean type\""
                + "                }" + "            }" + "        }," + "        {"
                + "            \"id\": \"ThirdDynamicType\"," + "            \"name\": \"Third dynamic type\","
                + "            \"classification\": \"dynamic\"," + "            \"type\": \"object\","
                + "            \"description\": \"not in use\"," + "            \"properties\": {"
                + "                \"timestamp\": {" + "                    \"format\": \"date-time\","
                + "                    \"type\": \"string\"," + "                    \"isindex\": true,"
                + "                    \"description\": \"not in use\"" + "                },"
                + "                \"IntegerEnum\": {" + "                    \"type\": \"integer\","
                + "                    \"format\": \"int16\"," + "                    \"enum\": [0, 1],"
                + "                    \"description\": \"Integer enumeration to replace boolean type\""
                + "                }" + "            }" + "        }" + "    ]";
    }

    private static String getFirstandSecondStaticTypeString() {
        return "[" + "        {" + "            \"id\": \"FirstStaticType\","
                + "            \"name\": \"First static type\"," + "            \"classification\": \"static\","
                + "            \"type\": \"object\"," + "            \"description\": \"First static asset type\","
                + "            \"properties\": {" + "                \"index\": {"
                + "                    \"type\": \"string\"," + "                    \"isindex\": true,"
                + "                    \"description\": \"not in use\"" + "                },"
                + "                \"name\": {" + "                    \"type\": \"string\","
                + "                    \"isname\": true," + "                    \"description\": \"not in use\""
                + "                }," + "                \"StringProperty\": {"
                + "                    \"type\": \"string\","
                + "                    \"description\": \"First static asset type's configuration attribute\""
                + "                }" + "            }" + "        }," + "        {"
                + "            \"id\": \"SecondStaticType\"," + "            \"name\": \"Second static type\","
                + "            \"classification\": \"static\"," + "            \"type\": \"object\","
                + "            \"description\": \"Second static asset type\"," + "            \"properties\": {"
                + "                \"index\": {" + "                    \"type\": \"string\","
                + "                    \"isindex\": true," + "                    \"description\": \"not in use\""
                + "                }," + "                \"name\": {" + "                    \"type\": \"string\","
                + "                    \"isname\": true," + "                    \"description\": \"not in use\""
    ...
    public static String getValue(String urlIn) throws Exception {
        ...
        try {
            ...
            throw new Exception(
                    "Get value failed." + url.toString() + "  " + httpResult + "  " + httpErrorMessage.toString());
        }
